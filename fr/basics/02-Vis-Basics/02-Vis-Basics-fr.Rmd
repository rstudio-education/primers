...
{ggplot2} contient plus de 30 fonctions _geom_ que vous pouvez utiliser, et d'autres packages en procurent encore d'avantage (regarder <https://www.ggplot2-exts.org> pour une liste non exhaustive). Vous apprendrez comment utiliser ces geoms pour l'exploration de données dans le primer [Visualiser des données]().
