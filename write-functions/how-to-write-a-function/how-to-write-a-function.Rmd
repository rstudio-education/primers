...
R comes with thousands of functions, and more are written everyday and published in R packages. If you want to something in R, there is a good chance that a function already exists somewhere that does it.
...
You can follow the same four steps to write any function in R. The steps easy to follow, and they ensure that your functions will work, which frees you to spend more time using your functions and less time debugging them.
...
Consider these steps as the "best practice" for writing functions in R. Let's use them to create your first function.

### Goal - Grading

To make this real, put yourself in the shoes of a teacher: 

You've given your students 10 homework assignments and announced that you will drop their lowest homework score. The final grade will be the average score of the remaining homeworks.
...
* Create an object named `x` that contains the vector `c(100, 100, 100, 100, 100, 100, 100, 100, 100, 90)` (hint: copy and paste can save you a lot of typing here). Then click Submit Answer. `x` will be the grades of your test student. 
...
You can place as many lines of code between the braces as you like. `function()` returns an R function that uses everything between the braces in its body. If you'd like to save the function, you'll need to assign it in the usual way to an R object that you can call later.

### \t

Once you save a function, you can run it and inspect its contents in the usual ways.
