...
question('Suppose `sign` is supposed to give a warning if it is given a non-numeric value, but instead issues a warning when passed a string like `"0.0"`. How should this be classified for testing purposes?',
