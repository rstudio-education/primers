...
```{r map_dbl-check}
"Good job. Now your results come back as a numeric vector. This is useful. For example, you could pass the results directly to round() without using another call to map(): list1 %>% map(log) %>% round()."
```
